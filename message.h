...
#define		TYPE_PACKET_RECEIVED	1
#define		TYPE_PACKET_SEND		2
#define		TYPE_PACKET_SEND_CONFIRM	3
#define		TYPE_SERVER_REQUEST		4
#define		TYPE_SERVER_RESPONSE	5
#define		TYPE_REPORT_STATUS		6
#define		TYPE_REPORT_VALUE		7
#define		TYPE_REPORT_VALUES		8
#define		TYPE_RESPONSE_REPORT_VALUE	9
