...
COBJS     = 
CPPOBJS   = main.o Terminal.o config.o hiduart.o cp211x.o agent.o node.o thread.o trace.o trace_master.o exception.o locker.o object.o time.o timer.o utils.o mqttclient.o message.o messagequeue.o activeobject.o mutex.o
OBJS      = $(COBJS) $(CPPOBJS)
